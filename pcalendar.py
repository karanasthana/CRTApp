...
class Calendar(ttk.Frame):
    ...
    def __init__(self, master=None, updateFunc=None, entryBox=None, **kw):
        """
        ...
        self.__setup_selection(sel_bg, sel_fg,updateFunc,master,entryBox)
    ...
    def __setup_selection(self, sel_bg, sel_fg,updateFunc,calframe,entryBox):
        ...
        self._calendar.bind('<ButtonPress-1>', lambda event:self._pressed(event,updateFunc,calframe,entryBox))
    ...
    def _pressed(self, evt, updateFunc,calframe,entryBox):
...
def test():
    ...
    # print ttkcal._date.year
    # a = Tkinter.Toplevel(root)
    # ttkcall = Calendar(a,firstweekday=calendar.SUNDAY)
    # ttkcall.pack(expand=1, fill='both')
    # a.mainloop()
